...
channel.QueueBind(queue: queueName, exchange: "myrootingexchange", routingKey: "EUairline");
channel.QueueBind(queue: queueName, exchange: "myrootingexchange", routingKey: "airline");
...
consumer.Received += (model, ea) =>
{
    ...
    Console.WriteLine($"Airline EU: {message}");
};
